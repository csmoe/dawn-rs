...
impl<T> CallbackFuture<T> {
    fn new() -> (Self, Arc<Mutex<CallbackShared<T>>>) {
        let shared = Arc::new(Mutex::new(CallbackShared { result: None, waker: None }));
...
fn map_texture_format(value: wgpu::TextureFormat) -> TextureFormat {
    ...
    match value {
        ...
        W::Astc { block, channel } => match (block, channel) {
            ...
            (wgpu::AstcBlock::B4x4, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc4X4UnormSrgb,
            (wgpu::AstcBlock::B5x4, wgpu::AstcChannel::Unorm) => TextureFormat::Astc5X4Unorm,
            (wgpu::AstcBlock::B5x4, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc5X4UnormSrgb,
            (wgpu::AstcBlock::B5x5, wgpu::AstcChannel::Unorm) => TextureFormat::Astc5X5Unorm,
            (wgpu::AstcBlock::B5x5, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc5X5UnormSrgb,
            (wgpu::AstcBlock::B6x5, wgpu::AstcChannel::Unorm) => TextureFormat::Astc6X5Unorm,
            (wgpu::AstcBlock::B6x5, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc6X5UnormSrgb,
            (wgpu::AstcBlock::B6x6, wgpu::AstcChannel::Unorm) => TextureFormat::Astc6X6Unorm,
            (wgpu::AstcBlock::B6x6, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc6X6UnormSrgb,
            (wgpu::AstcBlock::B8x5, wgpu::AstcChannel::Unorm) => TextureFormat::Astc8X5Unorm,
            (wgpu::AstcBlock::B8x5, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc8X5UnormSrgb,
            (wgpu::AstcBlock::B8x6, wgpu::AstcChannel::Unorm) => TextureFormat::Astc8X6Unorm,
            (wgpu::AstcBlock::B8x6, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc8X6UnormSrgb,
            (wgpu::AstcBlock::B8x8, wgpu::AstcChannel::Unorm) => TextureFormat::Astc8X8Unorm,
            (wgpu::AstcBlock::B8x8, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc8X8UnormSrgb,
            (wgpu::AstcBlock::B10x5, wgpu::AstcChannel::Unorm) => TextureFormat::Astc10X5Unorm,
            (wgpu::AstcBlock::B10x5, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc10X5UnormSrgb,
            (wgpu::AstcBlock::B10x6, wgpu::AstcChannel::Unorm) => TextureFormat::Astc10X6Unorm,
            (wgpu::AstcBlock::B10x6, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc10X6UnormSrgb,
            (wgpu::AstcBlock::B10x8, wgpu::AstcChannel::Unorm) => TextureFormat::Astc10X8Unorm,
            (wgpu::AstcBlock::B10x8, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc10X8UnormSrgb,
            (wgpu::AstcBlock::B10x10, wgpu::AstcChannel::Unorm) => TextureFormat::Astc10X10Unorm,
            (wgpu::AstcBlock::B10x10, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc10X10UnormSrgb,
            (wgpu::AstcBlock::B12x10, wgpu::AstcChannel::Unorm) => TextureFormat::Astc12X10Unorm,
            (wgpu::AstcBlock::B12x10, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc12X10UnormSrgb,
            (wgpu::AstcBlock::B12x12, wgpu::AstcChannel::Unorm) => TextureFormat::Astc12X12Unorm,
            (wgpu::AstcBlock::B12x12, wgpu::AstcChannel::UnormSrgb) => TextureFormat::Astc12X12UnormSrgb,
...
fn map_texture_format_to_wgpu(value: TextureFormat) -> wgpu::TextureFormat {
    ...
    match value {
        ...
        TextureFormat::Astc4X4Unorm => W::Astc { block: wgpu::AstcBlock::B4x4, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc4X4UnormSrgb => W::Astc { block: wgpu::AstcBlock::B4x4, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc5X4Unorm => W::Astc { block: wgpu::AstcBlock::B5x4, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc5X4UnormSrgb => W::Astc { block: wgpu::AstcBlock::B5x4, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc5X5Unorm => W::Astc { block: wgpu::AstcBlock::B5x5, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc5X5UnormSrgb => W::Astc { block: wgpu::AstcBlock::B5x5, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc6X5Unorm => W::Astc { block: wgpu::AstcBlock::B6x5, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc6X5UnormSrgb => W::Astc { block: wgpu::AstcBlock::B6x5, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc6X6Unorm => W::Astc { block: wgpu::AstcBlock::B6x6, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc6X6UnormSrgb => W::Astc { block: wgpu::AstcBlock::B6x6, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc8X5Unorm => W::Astc { block: wgpu::AstcBlock::B8x5, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc8X5UnormSrgb => W::Astc { block: wgpu::AstcBlock::B8x5, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc8X6Unorm => W::Astc { block: wgpu::AstcBlock::B8x6, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc8X6UnormSrgb => W::Astc { block: wgpu::AstcBlock::B8x6, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc8X8Unorm => W::Astc { block: wgpu::AstcBlock::B8x8, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc8X8UnormSrgb => W::Astc { block: wgpu::AstcBlock::B8x8, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc10X5Unorm => W::Astc { block: wgpu::AstcBlock::B10x5, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc10X5UnormSrgb => W::Astc { block: wgpu::AstcBlock::B10x5, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc10X6Unorm => W::Astc { block: wgpu::AstcBlock::B10x6, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc10X6UnormSrgb => W::Astc { block: wgpu::AstcBlock::B10x6, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc10X8Unorm => W::Astc { block: wgpu::AstcBlock::B10x8, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc10X8UnormSrgb => W::Astc { block: wgpu::AstcBlock::B10x8, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc10X10Unorm => W::Astc { block: wgpu::AstcBlock::B10x10, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc10X10UnormSrgb => W::Astc { block: wgpu::AstcBlock::B10x10, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc12X10Unorm => W::Astc { block: wgpu::AstcBlock::B12x10, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc12X10UnormSrgb => W::Astc { block: wgpu::AstcBlock::B12x10, channel: wgpu::AstcChannel::UnormSrgb },
        TextureFormat::Astc12X12Unorm => W::Astc { block: wgpu::AstcBlock::B12x12, channel: wgpu::AstcChannel::Unorm },
        TextureFormat::Astc12X12UnormSrgb => W::Astc { block: wgpu::AstcBlock::B12x12, channel: wgpu::AstcChannel::UnormSrgb },
    ...
    let (depth_load_op, depth_store_op, depth_clear_value) = match attachment.depth_ops.as_ref() {
        Some(ops) => match ops.load {
            ...
            wgpu::LoadOp::Clear(value) => {
                (Some(LoadOp::Clear), Some(map_store_op(ops.store)), Some(value))
            }
            wgpu::LoadOp::DontCare(_) => (Some(LoadOp::Load), Some(map_store_op(ops.store)), None),
        },
        None => (None, None, None),
    };
    let (stencil_load_op, stencil_store_op, stencil_clear_value) =
        match attachment.stencil_ops.as_ref() {
            Some(ops) => match ops.load {
                wgpu::LoadOp::Load => (Some(LoadOp::Load), Some(map_store_op(ops.store)), None),
                wgpu::LoadOp::Clear(value) => {
                    (Some(LoadOp::Clear), Some(map_store_op(ops.store)), Some(value))
                ...
                wgpu::LoadOp::DontCare(_) => {
                    (Some(LoadOp::Load), Some(map_store_op(ops.store)), None)
                }
            },
            None => (None, None, None),
        };
...
fn map_surface_capabilities(caps: SurfaceCapabilities) -> wgpu::SurfaceCapabilities {
    wgpu::SurfaceCapabilities {
        formats: caps
            ...
            .collect(),
        present_modes: caps.present_modes.clone().unwrap_or_default().iter().copied().map(|m| match m {
        ...
        alpha_modes: caps.alpha_modes.clone().unwrap_or_default().iter().copied().map(|m| match m {
                    ...
                    .map(|message| {
                        wgpu::CompilationMessage {
                            ...
                            message_type: match message.r#type.unwrap_or(CompilationMessageType::Info) {
                                ...
                                CompilationMessageType::Warning => wgpu::CompilationMessageType::Warning,
...
fn map_limits_to_dawn(limits: &wgpu::Limits) -> Limits {
    ...
    out.max_dynamic_uniform_buffers_per_pipeline_layout = Some(limits.max_dynamic_uniform_buffers_per_pipeline_layout);
    out.max_dynamic_storage_buffers_per_pipeline_layout = Some(limits.max_dynamic_storage_buffers_per_pipeline_layout);
    ...
    out.max_bind_groups_plus_vertex_buffers = Some(limits.max_bind_groups + limits.max_vertex_buffers);
    out
}

fn map_limits_to_wgpu(limits: &Limits) -> wgpu::Limits {
    let mut out = wgpu::Limits::default();
    if let Some(value) = limits.max_texture_dimension_1d { out.max_texture_dimension_1d = value; }
    if let Some(value) = limits.max_texture_dimension_2d { out.max_texture_dimension_2d = value; }
    if let Some(value) = limits.max_texture_dimension_3d { out.max_texture_dimension_3d = value; }
    if let Some(value) = limits.max_texture_array_layers { out.max_texture_array_layers = value; }
    if let Some(value) = limits.max_bind_groups { out.max_bind_groups = value; }
    if let Some(value) = limits.max_bindings_per_bind_group { out.max_bindings_per_bind_group = value; }
    if let Some(value) = limits.max_dynamic_uniform_buffers_per_pipeline_layout { out.max_dynamic_uniform_buffers_per_pipeline_layout = value; }
    if let Some(value) = limits.max_dynamic_storage_buffers_per_pipeline_layout { out.max_dynamic_storage_buffers_per_pipeline_layout = value; }
    if let Some(value) = limits.max_sampled_textures_per_shader_stage { out.max_sampled_textures_per_shader_stage = value; }
    if let Some(value) = limits.max_samplers_per_shader_stage { out.max_samplers_per_shader_stage = value; }
    if let Some(value) = limits.max_storage_buffers_per_shader_stage { out.max_storage_buffers_per_shader_stage = value; }
    if let Some(value) = limits.max_storage_textures_per_shader_stage { out.max_storage_textures_per_shader_stage = value; }
    if let Some(value) = limits.max_uniform_buffers_per_shader_stage { out.max_uniform_buffers_per_shader_stage = value; }
    if let Some(value) = limits.max_uniform_buffer_binding_size { out.max_uniform_buffer_binding_size = value as u32; }
    if let Some(value) = limits.max_storage_buffer_binding_size { out.max_storage_buffer_binding_size = value as u32; }
    if let Some(value) = limits.min_uniform_buffer_offset_alignment { out.min_uniform_buffer_offset_alignment = value; }
    if let Some(value) = limits.min_storage_buffer_offset_alignment { out.min_storage_buffer_offset_alignment = value; }
    if let Some(value) = limits.max_vertex_buffers { out.max_vertex_buffers = value; }
    if let Some(value) = limits.max_buffer_size { out.max_buffer_size = value; }
    if let Some(value) = limits.max_vertex_attributes { out.max_vertex_attributes = value; }
    if let Some(value) = limits.max_vertex_buffer_array_stride { out.max_vertex_buffer_array_stride = value; }
    if let Some(value) = limits.max_inter_stage_shader_variables { out.max_inter_stage_shader_components = value; }
    if let Some(value) = limits.max_color_attachments { out.max_color_attachments = value; }
    if let Some(value) = limits.max_color_attachment_bytes_per_sample { out.max_color_attachment_bytes_per_sample = value; }
    if let Some(value) = limits.max_compute_workgroup_storage_size { out.max_compute_workgroup_storage_size = value; }
    if let Some(value) = limits.max_compute_invocations_per_workgroup { out.max_compute_invocations_per_workgroup = value; }
    if let Some(value) = limits.max_compute_workgroup_size_x { out.max_compute_workgroup_size_x = value; }
    if let Some(value) = limits.max_compute_workgroup_size_y { out.max_compute_workgroup_size_y = value; }
    if let Some(value) = limits.max_compute_workgroup_size_z { out.max_compute_workgroup_size_z = value; }
    if let Some(value) = limits.max_compute_workgroups_per_dimension { out.max_compute_workgroups_per_dimension = value; }
    out
}

fn map_features_to_dawn(features: wgpu::Features) -> Vec<FeatureName> {
    let mut out = Vec::new();
    if features.contains(wgpu::Features::DEPTH_CLIP_CONTROL) { out.push(FeatureName::DepthClipControl); }
    if features.contains(wgpu::Features::DEPTH32FLOAT_STENCIL8) { out.push(FeatureName::Depth32FloatStencil8); }
    if features.contains(wgpu::Features::TEXTURE_COMPRESSION_BC) { out.push(FeatureName::TextureCompressionBc); }
    if features.contains(wgpu::Features::TEXTURE_COMPRESSION_BC_SLICED_3D) { out.push(FeatureName::TextureCompressionBcSliced3D); }
    if features.contains(wgpu::Features::TEXTURE_COMPRESSION_ETC2) { out.push(FeatureName::TextureCompressionEtc2); }
    if features.contains(wgpu::Features::TEXTURE_COMPRESSION_ASTC) { out.push(FeatureName::TextureCompressionAstc); }
    if features.contains(wgpu::Features::TEXTURE_COMPRESSION_ASTC_HDR) { out.push(FeatureName::TextureCompressionAstc); }
    if features.contains(wgpu::Features::TIMESTAMP_QUERY) { out.push(FeatureName::TimestampQuery); }
    if features.contains(wgpu::Features::INDIRECT_FIRST_INSTANCE) { out.push(FeatureName::IndirectFirstInstance); }
    if features.contains(wgpu::Features::SHADER_F16) { out.push(FeatureName::ShaderF16); }
    if features.contains(wgpu::Features::RG11B10UFLOAT_RENDERABLE) { out.push(FeatureName::Rg11B10UfloatRenderable); }
    if features.contains(wgpu::Features::BGRA8UNORM_STORAGE) { out.push(FeatureName::Bgra8UnormStorage); }
    if features.contains(wgpu::Features::FLOAT32_FILTERABLE) { out.push(FeatureName::Float32Filterable); }
    if features.contains(wgpu::Features::CLIP_DISTANCES) { out.push(FeatureName::ClipDistances); }
    if features.contains(wgpu::Features::DUAL_SOURCE_BLENDING) { out.push(FeatureName::DualSourceBlending); }
    if features.contains(wgpu::Features::SUBGROUP) { out.push(FeatureName::Subgroups); }
    if features.contains(wgpu::Features::TEXTURE_FORMAT_16BIT_NORM) { out.push(FeatureName::Unorm16TextureFormats); }
    if features.contains(wgpu::Features::MULTI_DRAW_INDIRECT_COUNT) { out.push(FeatureName::MultiDrawIndirect); }
    out
}
    ...
    if let Some(list) = &features.features {
        for feature in list {
            match feature {
                ...
                FeatureName::TextureCompressionBcSliced3D => out |= wgpu::Features::TEXTURE_COMPRESSION_BC_SLICED_3D,
                FeatureName::TextureCompressionEtc2 => out |= wgpu::Features::TEXTURE_COMPRESSION_ETC2,
                FeatureName::TextureCompressionAstc => out |= wgpu::Features::TEXTURE_COMPRESSION_ASTC,
                FeatureName::TimestampQuery => out |= wgpu::Features::TIMESTAMP_QUERY,
                FeatureName::IndirectFirstInstance => out |= wgpu::Features::INDIRECT_FIRST_INSTANCE,
                FeatureName::ShaderF16 => out |= wgpu::Features::SHADER_F16,
                FeatureName::Rg11B10UfloatRenderable => out |= wgpu::Features::RG11B10UFLOAT_RENDERABLE,
                ...
                FeatureName::Unorm16TextureFormats => out |= wgpu::Features::TEXTURE_FORMAT_16BIT_NORM,
...
fn dispatch_compute_pass(pass: ComputePassEncoder) -> DispatchComputePass {
    DispatchComputePass::custom(DawnComputePass { inner: pass })
}

fn dispatch_render_pass(pass: RenderPassEncoder) -> DispatchRenderPass {
    DispatchRenderPass::custom(DawnRenderPass { inner: pass })
}
...
impl InstanceInterface for DawnInstance {
    ...
    unsafe fn create_surface(
        ...
        match target {
            ...
            wgpu::SurfaceTargetUnsafe::CoreAnimationLayer(layer) => {
                ...
                let dawn_surface = DawnSurface { inner: surface, metal_layer: None };
                Ok(dispatch_surface(dawn_surface))
            }
            #[cfg(target_os = "macos")]
            wgpu::SurfaceTargetUnsafe::RawHandle { raw_window_handle, .. } => {
                ...
                match raw_window_handle {
                    RawWindowHandle::AppKit(handle) => {
                        ...
                        let mut desc = SurfaceDescriptor::new();
                        let source = SurfaceSourceMetalLayer { layer: Some(layer_ptr.as_ptr().cast()) };
                        desc = desc.with_extension(SurfaceDescriptorExtension::from(source));
                        let surface = self.inner.create_surface(&desc);
                        let handle = MetalLayerHandle { ptr: layer_ptr.as_ptr().cast() };
                        let dawn_surface = DawnSurface { inner: surface, metal_layer: Some(Arc::new(handle)) };
                        Ok(dispatch_surface(dawn_surface))
                    }
    ...
    fn request_adapter(
        ...
        let _ = self.inner.request_adapter(
            Some(&dawn_options),
...
impl AdapterInterface for DawnAdapter {
    fn request_device(
        ...
        let _ = self.inner.request_device(
            Some(&dawn_desc),
            move |status, device, _message| {
                if status == RequestDeviceStatus::Success {
                    let device = device.expect("wgpu-compat: missing device");
                    let queue = device.get_queue();
                    complete_shared(&shared, Ok((dispatch_device(device), dispatch_queue(queue))));
                } else {
    ...
    fn pop_error_scope(&self, _index: u32) -> Pin<Box<dyn wgpu::custom::PopErrorScopeFuture>> {
        ...
        let _ = self.inner.pop_error_scope(move |status, ty, message| {
            if status == PopErrorScopeStatus::Success {
                ...
                complete_shared(&shared, Some(wgpu::Error::Internal {
...
impl CommandEncoderInterface for DawnCommandEncoder {
    ...
    fn clear_texture(&self, texture: &DispatchTexture, subresource_range: &wgpu::ImageSubresourceRange) {
        let _ = texture;
    ...
    fn clear_buffer(&self, buffer: &DispatchBuffer, offset: wgpu::BufferAddress, size: Option<wgpu::BufferAddress>) {
        let buffer = expect_buffer(buffer);
        self.inner.clear_buffer(buffer, offset, size.unwrap_or(WHOLE_SIZE));
    }
    ...
    fn resolve_query_set(
        ...
        self.inner.resolve_query_set(set, first_query, query_count, buffer, destination_offset);
    }
    ...
    fn transition_resources<'a>(
        ...
        _texture_transitions: &mut dyn Iterator<Item = wgpu::TextureTransition<&'a DispatchTexture>>,
    ) {
    }
}
...
impl ComputePassInterface for DawnComputePass {
    ...
    fn dispatch_workgroups_indirect(
        ...
        self.inner.dispatch_workgroups_indirect(buffer, indirect_offset);
    }
...
impl RenderPassInterface for DawnRenderPass {
    ...
    fn set_index_buffer(
        ...
        self.inner.set_index_buffer(buffer, map_index_format(index_format), offset, size);
    }
    ...
    fn set_vertex_buffer(
        ...
        let buffer = expect_buffer(buffer);
        let size = size.map(|v| v.get()).unwrap_or(WHOLE_SIZE);
        self.inner.set_vertex_buffer(slot, Some(buffer), offset, size);
    }
    ...
    fn set_viewport(&mut self, x: f32, y: f32, width: f32, height: f32, min_depth: f32, max_depth: f32) {
        self.inner.set_viewport(x, y, width, height, min_depth, max_depth);
    }
    ...
    fn draw(&mut self, vertices: std::ops::Range<u32>, instances: std::ops::Range<u32>) {
        self.inner.draw(vertices.end - vertices.start, instances.end - instances.start, vertices.start, instances.start);
    }

    fn draw_indexed(&mut self, indices: std::ops::Range<u32>, base_vertex: i32, instances: std::ops::Range<u32>) {
        self.inner.draw_indexed(indices.end - indices.start, instances.end - instances.start, indices.start, base_vertex, instances.start);
    }
    ...
    fn draw_indexed_indirect(&mut self, indirect_buffer: &DispatchBuffer, indirect_offset: wgpu::BufferAddress) {
        let buffer = expect_buffer(indirect_buffer);
        self.inner.draw_indexed_indirect(buffer, indirect_offset);
    }

    fn draw_mesh_tasks_indirect(&mut self, _indirect_buffer: &DispatchBuffer, _indirect_offset: wgpu::BufferAddress) {
        panic!("wgpu-compat: mesh tasks not supported");
    }

    fn multi_draw_indirect(&mut self, indirect_buffer: &DispatchBuffer, indirect_offset: wgpu::BufferAddress, count: u32) {
        let buffer = expect_buffer(indirect_buffer);
        self.inner
            .multi_draw_indirect(buffer, indirect_offset, count, None, 0);
    }

    fn multi_draw_indexed_indirect(&mut self, indirect_buffer: &DispatchBuffer, indirect_offset: wgpu::BufferAddress, count: u32) {
        let buffer = expect_buffer(indirect_buffer);
        self.inner
...
impl SurfaceInterface for DawnSurface {
    ...
    fn get_current_texture(
        ...
        let status = match surface_texture.status.unwrap_or(SurfaceGetCurrentTextureStatus::Error) {
...
pub fn from_wgpu_query_set(
    query_set: &wgpu::QuerySet,
) -> Result<QuerySet, WgpuCompatError> {
    query_set
        .as_custom::<DawnQuerySet>()
        .map(|q| q.inner.clone())
        .ok_or(WgpuCompatError::NotDawnBackend)
