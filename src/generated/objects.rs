...
impl Adapter {
    ...
    pub fn get_features(&self, features: &mut SupportedFeatures) -> () {
                let mut features_ffi = features.to_ffi();
    ...
    pub fn request_device(&self, descriptor: Option<&DeviceDescriptor>, callback: impl FnMut(RequestDeviceStatus, Option<Device>, String) + Send + 'static) -> Future {
        ...
        let result = unsafe { ffi::wgpuAdapterRequestDevice(self.raw, std::ptr::null(), callback_info_ffi) };
        Future::new()
    }

    pub fn create_device(&self, descriptor: Option<&DeviceDescriptor>) -> Device {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuAdapterCreateDevice(self.raw, std::ptr::null()) };
    ...
    pub fn get_format_capabilities(&self, format: TextureFormat, capabilities: &mut DawnFormatCapabilities) -> Status {
        ...
        let result = unsafe { ffi::wgpuAdapterGetFormatCapabilities(self.raw, format_ffi, capabilities_ptr) };
...
impl Buffer {
    ...
    pub fn map_async(&self, mode: MapMode, offset: usize, size: usize, callback: impl FnMut(MapAsyncStatus, String) + Send + 'static) -> Future {
        ...
        let result = unsafe { ffi::wgpuBufferMapAsync(self.raw, mode_ffi, offset, size, callback_info_ffi) };
        Future::new()
    }
    ...
    pub fn get_const_mapped_range(&self, offset: usize, size: usize) -> *const std::ffi::c_void {

        let result = unsafe { ffi::wgpuBufferGetConstMappedRange(self.raw, offset, size) };
        result
    }

    pub fn write_mapped_range(&self, offset: usize, data: Vec<std::ffi::c_void>, size: usize) -> Status {

        let result = unsafe { ffi::wgpuBufferWriteMappedRange(self.raw, offset, data.as_ptr(), size) };
        result.into()
    }

    pub fn read_mapped_range(&self, offset: usize, mut data: Vec<std::ffi::c_void>, size: usize) -> Status {

        let result = unsafe { ffi::wgpuBufferReadMappedRange(self.raw, offset, data.as_mut_ptr(), size) };
        result.into()
    }
...
impl CommandEncoder {
    ...
    pub fn finish(&self, descriptor: Option<&CommandBufferDescriptor>) -> CommandBuffer {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuCommandEncoderFinish(self.raw, std::ptr::null()) };
    ...
    pub fn begin_compute_pass(&self, descriptor: Option<&ComputePassDescriptor>) -> ComputePassEncoder {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuCommandEncoderBeginComputePass(self.raw, std::ptr::null()) };
    ...
    pub fn begin_render_pass(&self, descriptor: &RenderPassDescriptor) -> RenderPassEncoder {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuCommandEncoderBeginRenderPass(self.raw, descriptor_ptr) };
    ...
    pub fn copy_buffer_to_buffer(&self, source: Buffer, source_offset: u64, destination: Buffer, destination_offset: u64, size: u64) -> () {
        ...
        unsafe { ffi::wgpuCommandEncoderCopyBufferToBuffer(self.raw, source.raw, source_offset, destination.raw, destination_offset, size) };
        ()
    }

    pub fn copy_buffer_to_texture(&self, source: &TexelCopyBufferInfo, destination: &TexelCopyTextureInfo, copy_size: &Extent3D) -> () {
                let source_ffi = source.to_ffi();
                let source_ptr = std::ptr::addr_of!(source_ffi);
                let destination_ffi = destination.to_ffi();
                let destination_ptr = std::ptr::addr_of!(destination_ffi);
                let copy_size_ffi = copy_size.to_ffi();
                let copy_size_ptr = std::ptr::addr_of!(copy_size_ffi);
        unsafe { ffi::wgpuCommandEncoderCopyBufferToTexture(self.raw, source_ptr, destination_ptr, copy_size_ptr) };
        ()
    }
    ...
    pub fn copy_texture_to_buffer(&self, source: &TexelCopyTextureInfo, destination: &TexelCopyBufferInfo, copy_size: &Extent3D) -> () {
                ...
                let copy_size_ffi = copy_size.to_ffi();
                let copy_size_ptr = std::ptr::addr_of!(copy_size_ffi);
        unsafe { ffi::wgpuCommandEncoderCopyTextureToBuffer(self.raw, source_ptr, destination_ptr, copy_size_ptr) };
        ()
    }
    ...
    pub fn copy_texture_to_texture(&self, source: &TexelCopyTextureInfo, destination: &TexelCopyTextureInfo, copy_size: &Extent3D) -> () {
                ...
                let copy_size_ffi = copy_size.to_ffi();
                let copy_size_ptr = std::ptr::addr_of!(copy_size_ffi);
        unsafe { ffi::wgpuCommandEncoderCopyTextureToTexture(self.raw, source_ptr, destination_ptr, copy_size_ptr) };
        ()
    }

    pub fn clear_buffer(&self, buffer: Buffer, offset: u64, size: u64) -> () {

        unsafe { ffi::wgpuCommandEncoderClearBuffer(self.raw, buffer.raw, offset, size) };
        ()
    }
    ...
    pub fn resolve_query_set(&self, query_set: QuerySet, first_query: u32, query_count: u32, destination: Buffer, destination_offset: u64) -> () {
        ...
        unsafe { ffi::wgpuCommandEncoderResolveQuerySet(self.raw, query_set.raw, first_query, query_count, destination.raw, destination_offset) };
        ()
    }

    pub fn write_buffer(&self, buffer: Buffer, buffer_offset: u64, data: Vec<u8>, size: u64) -> () {

        unsafe { ffi::wgpuCommandEncoderWriteBuffer(self.raw, buffer.raw, buffer_offset, data.as_ptr(), size) };
        ()
    }

    pub fn write_timestamp(&self, query_set: QuerySet, query_index: u32) -> () {

        unsafe { ffi::wgpuCommandEncoderWriteTimestamp(self.raw, query_set.raw, query_index) };
        ()
    }
    ...
    pub fn set_resource_table(&self, table: Option<ResourceTable>) -> () {
                let table_raw = table.as_ref().map(|v| v.raw).unwrap_or(std::ptr::null_mut());
...
impl ComputePassEncoder {
    ...
    pub fn insert_debug_marker(&self, marker_label: String) -> () {
        ...
        unsafe { ffi::wgpuComputePassEncoderInsertDebugMarker(self.raw, marker_label_ffi) };
        ()
    }
    ...
    pub fn set_pipeline(&self, pipeline: ComputePipeline) -> () {
        ...
        unsafe { ffi::wgpuComputePassEncoderSetPipeline(self.raw, pipeline.raw) };
        ()
    }

    pub fn set_bind_group(&self, group_index: u32, group: Option<BindGroup>, dynamic_offset_count: usize, dynamic_offsets: Vec<u32>) -> () {
                let group_raw = group.as_ref().map(|v| v.raw).unwrap_or(std::ptr::null_mut());
        unsafe { ffi::wgpuComputePassEncoderSetBindGroup(self.raw, group_index, group_raw, dynamic_offset_count, dynamic_offsets.as_ptr()) };
        ()
    }

    pub fn write_timestamp(&self, query_set: QuerySet, query_index: u32) -> () {

        unsafe { ffi::wgpuComputePassEncoderWriteTimestamp(self.raw, query_set.raw, query_index) };
        ()
    }

    pub fn dispatch_workgroups(&self, workgroup_count_x: u32, workgroup_count_y: u32, workgroup_count_z: u32) -> () {

        unsafe { ffi::wgpuComputePassEncoderDispatchWorkgroups(self.raw, workgroup_count_x, workgroup_count_y, workgroup_count_z) };
        ()
    }

    pub fn dispatch_workgroups_indirect(&self, indirect_buffer: Buffer, indirect_offset: u64) -> () {

        unsafe { ffi::wgpuComputePassEncoderDispatchWorkgroupsIndirect(self.raw, indirect_buffer.raw, indirect_offset) };
        ()
    }
    ...
    pub fn set_immediates(&self, offset: u32, data: Vec<std::ffi::c_void>, size: usize) -> () {

        unsafe { ffi::wgpuComputePassEncoderSetImmediates(self.raw, offset, data.as_ptr(), size) };
        ()
    }
}
...
impl ComputePipeline {
    ...
    pub fn get_bind_group_layout(&self, group_index: u32) -> BindGroupLayout {
        ...
        let result = unsafe { ffi::wgpuComputePipelineGetBindGroupLayout(self.raw, group_index) };
...
impl Device {
    ...
    pub fn create_bind_group_layout(&self, descriptor: &BindGroupLayoutDescriptor) -> BindGroupLayout {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateBindGroupLayout(self.raw, descriptor_ptr) };
        unsafe { BindGroupLayout::from_raw(result) }
    }
    ...
    pub fn create_error_buffer(&self, descriptor: &BufferDescriptor) -> Buffer {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateErrorBuffer(self.raw, descriptor_ptr) };
    ...
    pub fn create_command_encoder(&self, descriptor: Option<&CommandEncoderDescriptor>) -> CommandEncoder {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuDeviceCreateCommandEncoder(self.raw, std::ptr::null()) };
    ...
    pub fn create_compute_pipeline(&self, descriptor: &ComputePipelineDescriptor) -> ComputePipeline {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateComputePipeline(self.raw, descriptor_ptr) };
    ...
    pub fn create_compute_pipeline_async(&self, descriptor: &ComputePipelineDescriptor, callback: impl FnMut(CreatePipelineAsyncStatus, Option<ComputePipeline>, String) + Send + 'static) -> Future {
        ...
        let result = unsafe { ffi::wgpuDeviceCreateComputePipelineAsync(self.raw, descriptor_ptr, callback_info_ffi) };
        Future::new()
    }

    pub fn create_external_texture(&self, external_texture_descriptor: &ExternalTextureDescriptor) -> ExternalTexture {
                let (external_texture_descriptor_ffi, _external_texture_descriptor_storage) = external_texture_descriptor.to_ffi();
                let external_texture_descriptor_ptr = std::ptr::addr_of!(external_texture_descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateExternalTexture(self.raw, external_texture_descriptor_ptr) };
    ...
    pub fn create_pipeline_layout(&self, descriptor: &PipelineLayoutDescriptor) -> PipelineLayout {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreatePipelineLayout(self.raw, descriptor_ptr) };
    ...
    pub fn create_render_pipeline_async(&self, descriptor: &RenderPipelineDescriptor, callback: impl FnMut(CreatePipelineAsyncStatus, Option<RenderPipeline>, String) + Send + 'static) -> Future {
        ...
        let result = unsafe { ffi::wgpuDeviceCreateRenderPipelineAsync(self.raw, descriptor_ptr, callback_info_ffi) };
        Future::new()
    }
    ...
    pub fn create_render_bundle_encoder(&self, descriptor: &RenderBundleEncoderDescriptor) -> RenderBundleEncoder {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateRenderBundleEncoder(self.raw, descriptor_ptr) };
    ...
    pub fn create_render_pipeline(&self, descriptor: &RenderPipelineDescriptor) -> RenderPipeline {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateRenderPipeline(self.raw, descriptor_ptr) };
        unsafe { RenderPipeline::from_raw(result) }
    }

    pub fn create_sampler(&self, descriptor: Option<&SamplerDescriptor>) -> Sampler {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuDeviceCreateSampler(self.raw, std::ptr::null()) };
    ...
    pub fn create_shader_module(&self, descriptor: &ShaderModuleDescriptor) -> ShaderModule {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateShaderModule(self.raw, descriptor_ptr) };
    ...
    pub fn create_error_shader_module(&self, descriptor: &ShaderModuleDescriptor, error_message: String) -> ShaderModule {
        ...
        let result = unsafe { ffi::wgpuDeviceCreateErrorShaderModule(self.raw, descriptor_ptr, error_message_ffi) };
        unsafe { ShaderModule::from_raw(result) }
    }
    ...
    pub fn create_resource_table(&self, descriptor: &ResourceTableDescriptor) -> ResourceTable {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateResourceTable(self.raw, descriptor_ptr) };
    ...
    pub fn import_shared_buffer_memory(&self, descriptor: &SharedBufferMemoryDescriptor) -> SharedBufferMemory {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceImportSharedBufferMemory(self.raw, descriptor_ptr) };
    ...
    pub fn import_shared_texture_memory(&self, descriptor: &SharedTextureMemoryDescriptor) -> SharedTextureMemory {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceImportSharedTextureMemory(self.raw, descriptor_ptr) };
    ...
    pub fn import_shared_fence(&self, descriptor: &SharedFenceDescriptor) -> SharedFence {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceImportSharedFence(self.raw, descriptor_ptr) };
    ...
    pub fn create_error_texture(&self, descriptor: &TextureDescriptor) -> Texture {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuDeviceCreateErrorTexture(self.raw, descriptor_ptr) };
        unsafe { Texture::from_raw(result) }
    }
    ...
    pub fn get_a_hardware_buffer_properties(&self, handle: *mut std::ffi::c_void, properties: &mut AHardwareBufferProperties) -> Status {
                let mut properties_ffi = properties.to_ffi();
                let properties_ptr = std::ptr::addr_of_mut!(properties_ffi);
        let result = unsafe { ffi::wgpuDeviceGetAHardwareBufferProperties(self.raw, handle, properties_ptr) };
    ...
    pub fn get_adapter_info(&self, adapter_info: &mut AdapterInfo) -> Status {
        ...
        let result = unsafe { ffi::wgpuDeviceGetAdapterInfo(self.raw, adapter_info_ptr) };
    ...
    pub fn pop_error_scope(&self, callback: impl FnMut(PopErrorScopeStatus, ErrorType, String) + Send + 'static) -> Future {
        ...
        let result = unsafe { ffi::wgpuDevicePopErrorScope(self.raw, callback_info_ffi) };
        Future::new()
    }
...
impl Instance {
    ...
    pub fn new(descriptor: Option<&InstanceDescriptor>) -> Self {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuCreateInstance(std::ptr::null()) };
        unsafe { Instance::from_raw(result) }
    }
    ...
    pub fn wait_any(&self, future_count: usize, futures: Option<Vec<FutureWaitInfo>>, timeout_ns: u64) -> WaitStatus {
                let _ = futures;
        let result = unsafe { ffi::wgpuInstanceWaitAny(self.raw, future_count, std::ptr::null_mut(), timeout_ns) };
        result.into()
    }
    ...
    pub fn request_adapter(&self, options: Option<&RequestAdapterOptions>, callback: impl FnMut(RequestAdapterStatus, Option<Adapter>, String) + Send + 'static) -> Future {
        ...
        let result = unsafe { ffi::wgpuInstanceRequestAdapter(self.raw, std::ptr::null(), callback_info_ffi) };
        Future::new()
    }
    ...
    pub fn has_wgsl_language_feature(&self, feature: WGSLLanguageFeatureName) -> bool {
        ...
        let result = unsafe { ffi::wgpuInstanceHasWGSLLanguageFeature(self.raw, feature_ffi) };
        result != 0
    }
...
impl Queue {
    ...
    pub fn submit(&self, command_count: usize, commands: Vec<CommandBuffer>) -> () {
                let commands_raw: Vec<ffi::WGPUCommandBuffer> = commands.iter().map(|v| v.raw).collect();
        unsafe { ffi::wgpuQueueSubmit(self.raw, command_count, commands_raw.as_ptr()) };
        ()
    }
    ...
    pub fn on_submitted_work_done(&self, callback: impl FnMut(QueueWorkDoneStatus, String) + Send + 'static) -> Future {
        ...
        let result = unsafe { ffi::wgpuQueueOnSubmittedWorkDone(self.raw, callback_info_ffi) };
        Future::new()
    }

    pub fn write_buffer(&self, buffer: Buffer, buffer_offset: u64, data: Vec<std::ffi::c_void>, size: usize) -> () {

        unsafe { ffi::wgpuQueueWriteBuffer(self.raw, buffer.raw, buffer_offset, data.as_ptr(), size) };
        ()
    }

    pub fn write_texture(&self, destination: &TexelCopyTextureInfo, data: Vec<std::ffi::c_void>, data_size: usize, data_layout: &TexelCopyBufferLayout, write_size: &Extent3D) -> () {
                let destination_ffi = destination.to_ffi();
                let destination_ptr = std::ptr::addr_of!(destination_ffi);
                let data_layout_ffi = data_layout.to_ffi();
                let data_layout_ptr = std::ptr::addr_of!(data_layout_ffi);
                let write_size_ffi = write_size.to_ffi();
                let write_size_ptr = std::ptr::addr_of!(write_size_ffi);
        unsafe { ffi::wgpuQueueWriteTexture(self.raw, destination_ptr, data.as_ptr(), data_size, data_layout_ptr, write_size_ptr) };
        ()
    }
    ...
    pub fn copy_texture_for_browser(&self, source: &TexelCopyTextureInfo, destination: &TexelCopyTextureInfo, copy_size: &Extent3D, options: &CopyTextureForBrowserOptions) -> () {
        ...
        unsafe { ffi::wgpuQueueCopyTextureForBrowser(self.raw, source_ptr, destination_ptr, copy_size_ptr, options_ptr) };
        ()
    }
    ...
    pub fn copy_external_texture_for_browser(&self, source: &ImageCopyExternalTexture, destination: &TexelCopyTextureInfo, copy_size: &Extent3D, options: &CopyTextureForBrowserOptions) -> () {
                ...
                let (options_ffi, _options_storage) = options.to_ffi();
                let options_ptr = std::ptr::addr_of!(options_ffi);
        unsafe { ffi::wgpuQueueCopyExternalTextureForBrowser(self.raw, source_ptr, destination_ptr, copy_size_ptr, options_ptr) };
        ()
    }
...
impl RenderBundleEncoder {
    ...
    pub fn set_pipeline(&self, pipeline: RenderPipeline) -> () {
        ...
        unsafe { ffi::wgpuRenderBundleEncoderSetPipeline(self.raw, pipeline.raw) };
        ()
    }

    pub fn set_bind_group(&self, group_index: u32, group: Option<BindGroup>, dynamic_offset_count: usize, dynamic_offsets: Vec<u32>) -> () {
                let group_raw = group.as_ref().map(|v| v.raw).unwrap_or(std::ptr::null_mut());
        unsafe { ffi::wgpuRenderBundleEncoderSetBindGroup(self.raw, group_index, group_raw, dynamic_offset_count, dynamic_offsets.as_ptr()) };
        ()
    }

    pub fn draw(&self, vertex_count: u32, instance_count: u32, first_vertex: u32, first_instance: u32) -> () {

        unsafe { ffi::wgpuRenderBundleEncoderDraw(self.raw, vertex_count, instance_count, first_vertex, first_instance) };
        ()
    }

    pub fn draw_indexed(&self, index_count: u32, instance_count: u32, first_index: u32, base_vertex: i32, first_instance: u32) -> () {

        unsafe { ffi::wgpuRenderBundleEncoderDrawIndexed(self.raw, index_count, instance_count, first_index, base_vertex, first_instance) };
        ()
    }

    pub fn draw_indirect(&self, indirect_buffer: Buffer, indirect_offset: u64) -> () {

        unsafe { ffi::wgpuRenderBundleEncoderDrawIndirect(self.raw, indirect_buffer.raw, indirect_offset) };
        ()
    }

    pub fn draw_indexed_indirect(&self, indirect_buffer: Buffer, indirect_offset: u64) -> () {

        unsafe { ffi::wgpuRenderBundleEncoderDrawIndexedIndirect(self.raw, indirect_buffer.raw, indirect_offset) };
        ()
    }
    ...
    pub fn insert_debug_marker(&self, marker_label: String) -> () {
        ...
        unsafe { ffi::wgpuRenderBundleEncoderInsertDebugMarker(self.raw, marker_label_ffi) };
        ()
    }
    ...
    pub fn set_vertex_buffer(&self, slot: u32, buffer: Option<Buffer>, offset: u64, size: u64) -> () {
                let buffer_raw = buffer.as_ref().map(|v| v.raw).unwrap_or(std::ptr::null_mut());
        unsafe { ffi::wgpuRenderBundleEncoderSetVertexBuffer(self.raw, slot, buffer_raw, offset, size) };
        ()
    }
    ...
    pub fn set_index_buffer(&self, buffer: Buffer, format: IndexFormat, offset: u64, size: u64) -> () {
        ...
        unsafe { ffi::wgpuRenderBundleEncoderSetIndexBuffer(self.raw, buffer.raw, format_ffi, offset, size) };
        ()
    }

    pub fn finish(&self, descriptor: Option<&RenderBundleDescriptor>) -> RenderBundle {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuRenderBundleEncoderFinish(self.raw, std::ptr::null()) };
    ...
    pub fn set_immediates(&self, offset: u32, data: Vec<std::ffi::c_void>, size: usize) -> () {
        ...
        unsafe { ffi::wgpuRenderBundleEncoderSetImmediates(self.raw, offset, data.as_ptr(), size) };
        ()
    }
}
...
impl RenderPassEncoder {
    ...
    pub fn set_pipeline(&self, pipeline: RenderPipeline) -> () {
        ...
        unsafe { ffi::wgpuRenderPassEncoderSetPipeline(self.raw, pipeline.raw) };
        ()
    }

    pub fn set_bind_group(&self, group_index: u32, group: Option<BindGroup>, dynamic_offset_count: usize, dynamic_offsets: Vec<u32>) -> () {
                let group_raw = group.as_ref().map(|v| v.raw).unwrap_or(std::ptr::null_mut());
        unsafe { ffi::wgpuRenderPassEncoderSetBindGroup(self.raw, group_index, group_raw, dynamic_offset_count, dynamic_offsets.as_ptr()) };
        ()
    }

    pub fn draw(&self, vertex_count: u32, instance_count: u32, first_vertex: u32, first_instance: u32) -> () {

        unsafe { ffi::wgpuRenderPassEncoderDraw(self.raw, vertex_count, instance_count, first_vertex, first_instance) };
        ()
    }

    pub fn draw_indexed(&self, index_count: u32, instance_count: u32, first_index: u32, base_vertex: i32, first_instance: u32) -> () {

        unsafe { ffi::wgpuRenderPassEncoderDrawIndexed(self.raw, index_count, instance_count, first_index, base_vertex, first_instance) };
        ()
    }

    pub fn draw_indirect(&self, indirect_buffer: Buffer, indirect_offset: u64) -> () {

        unsafe { ffi::wgpuRenderPassEncoderDrawIndirect(self.raw, indirect_buffer.raw, indirect_offset) };
        ()
    }

    pub fn draw_indexed_indirect(&self, indirect_buffer: Buffer, indirect_offset: u64) -> () {

        unsafe { ffi::wgpuRenderPassEncoderDrawIndexedIndirect(self.raw, indirect_buffer.raw, indirect_offset) };
        ()
    }

    pub fn multi_draw_indirect(&self, indirect_buffer: Buffer, indirect_offset: u64, max_draw_count: u32, draw_count_buffer: Option<Buffer>, draw_count_buffer_offset: u64) -> () {
                let draw_count_buffer_raw = draw_count_buffer.as_ref().map(|v| v.raw).unwrap_or(std::ptr::null_mut());
        unsafe { ffi::wgpuRenderPassEncoderMultiDrawIndirect(self.raw, indirect_buffer.raw, indirect_offset, max_draw_count, draw_count_buffer_raw, draw_count_buffer_offset) };
        ()
    }

    pub fn multi_draw_indexed_indirect(&self, indirect_buffer: Buffer, indirect_offset: u64, max_draw_count: u32, draw_count_buffer: Option<Buffer>, draw_count_buffer_offset: u64) -> () {
                let draw_count_buffer_raw = draw_count_buffer.as_ref().map(|v| v.raw).unwrap_or(std::ptr::null_mut());
        unsafe { ffi::wgpuRenderPassEncoderMultiDrawIndexedIndirect(self.raw, indirect_buffer.raw, indirect_offset, max_draw_count, draw_count_buffer_raw, draw_count_buffer_offset) };
        ()
    }

    pub fn execute_bundles(&self, bundle_count: usize, bundles: Vec<RenderBundle>) -> () {
                let bundles_raw: Vec<ffi::WGPURenderBundle> = bundles.iter().map(|v| v.raw).collect();
        unsafe { ffi::wgpuRenderPassEncoderExecuteBundles(self.raw, bundle_count, bundles_raw.as_ptr()) };
        ()
    }
    ...
    pub fn insert_debug_marker(&self, marker_label: String) -> () {
        ...
        unsafe { ffi::wgpuRenderPassEncoderInsertDebugMarker(self.raw, marker_label_ffi) };
        ()
    }
    ...
    pub fn set_viewport(&self, x: f32, y: f32, width: f32, height: f32, min_depth: f32, max_depth: f32) -> () {
        ...
        unsafe { ffi::wgpuRenderPassEncoderSetViewport(self.raw, x, y, width, height, min_depth, max_depth) };
        ()
    }

    pub fn set_scissor_rect(&self, x: u32, y: u32, width: u32, height: u32) -> () {

        unsafe { ffi::wgpuRenderPassEncoderSetScissorRect(self.raw, x, y, width, height) };
        ()
    }

    pub fn set_vertex_buffer(&self, slot: u32, buffer: Option<Buffer>, offset: u64, size: u64) -> () {
                let buffer_raw = buffer.as_ref().map(|v| v.raw).unwrap_or(std::ptr::null_mut());
        unsafe { ffi::wgpuRenderPassEncoderSetVertexBuffer(self.raw, slot, buffer_raw, offset, size) };
        ()
    }

    pub fn set_index_buffer(&self, buffer: Buffer, format: IndexFormat, offset: u64, size: u64) -> () {
                let format_ffi: ffi::WGPUIndexFormat = format.into();
        unsafe { ffi::wgpuRenderPassEncoderSetIndexBuffer(self.raw, buffer.raw, format_ffi, offset, size) };
        ()
    }
    ...
    pub fn write_timestamp(&self, query_set: QuerySet, query_index: u32) -> () {
        ...
        unsafe { ffi::wgpuRenderPassEncoderWriteTimestamp(self.raw, query_set.raw, query_index) };
        ()
    }
    ...
    pub fn set_immediates(&self, offset: u32, data: Vec<std::ffi::c_void>, size: usize) -> () {
        ...
        unsafe { ffi::wgpuRenderPassEncoderSetImmediates(self.raw, offset, data.as_ptr(), size) };
        ()
    }
}
...
impl RenderPipeline {
    ...
    pub fn get_bind_group_layout(&self, group_index: u32) -> BindGroupLayout {
        ...
        let result = unsafe { ffi::wgpuRenderPipelineGetBindGroupLayout(self.raw, group_index) };
        unsafe { BindGroupLayout::from_raw(result) }
    }
...
impl ResourceTable {
    ...
    pub fn update(&self, slot: u32, resource: &BindingResource) -> Status {
        ...
        let result = unsafe { ffi::wgpuResourceTableUpdate(self.raw, slot, resource_ptr) };
        result.into()
    }
    ...
    pub fn insert_binding(&self, resource: &BindingResource) -> u32 {
                let (resource_ffi, _resource_storage) = resource.to_ffi();
                let resource_ptr = std::ptr::addr_of!(resource_ffi);
        let result = unsafe { ffi::wgpuResourceTableInsertBinding(self.raw, resource_ptr) };
        result
    }
...
impl ShaderModule {
    ...
    pub fn get_compilation_info(&self, callback: impl FnMut(CompilationInfoRequestStatus, &CompilationInfo) + Send + 'static) -> Future {
        ...
        let result = unsafe { ffi::wgpuShaderModuleGetCompilationInfo(self.raw, callback_info_ffi) };
        Future::new()
    }
...
impl SharedBufferMemory {
    ...
    pub fn get_properties(&self, properties: &mut SharedBufferMemoryProperties) -> Status {
                let (mut properties_ffi, _properties_storage) = properties.to_ffi();
                let properties_ptr = std::ptr::addr_of_mut!(properties_ffi);
        let result = unsafe { ffi::wgpuSharedBufferMemoryGetProperties(self.raw, properties_ptr) };
    ...
    pub fn create_buffer(&self, descriptor: Option<&BufferDescriptor>) -> Buffer {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuSharedBufferMemoryCreateBuffer(self.raw, std::ptr::null()) };
        unsafe { Buffer::from_raw(result) }
    }

    pub fn begin_access(&self, buffer: Buffer, descriptor: &SharedBufferMemoryBeginAccessDescriptor) -> Status {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuSharedBufferMemoryBeginAccess(self.raw, buffer.raw, descriptor_ptr) };
        result.into()
    }

    pub fn end_access(&self, buffer: Buffer, descriptor: &mut SharedBufferMemoryEndAccessState) -> Status {
                let (mut descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of_mut!(descriptor_ffi);
        let result = unsafe { ffi::wgpuSharedBufferMemoryEndAccess(self.raw, buffer.raw, descriptor_ptr) };
...
impl SharedTextureMemory {
    ...
    pub fn get_properties(&self, properties: &mut SharedTextureMemoryProperties) -> Status {
                let (mut properties_ffi, _properties_storage) = properties.to_ffi();
                let properties_ptr = std::ptr::addr_of_mut!(properties_ffi);
        let result = unsafe { ffi::wgpuSharedTextureMemoryGetProperties(self.raw, properties_ptr) };
    ...
    pub fn create_texture(&self, descriptor: Option<&TextureDescriptor>) -> Texture {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuSharedTextureMemoryCreateTexture(self.raw, std::ptr::null()) };
        unsafe { Texture::from_raw(result) }
    }
    ...
    pub fn begin_access(&self, texture: Texture, descriptor: &SharedTextureMemoryBeginAccessDescriptor) -> Status {
                let (descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of!(descriptor_ffi);
        let result = unsafe { ffi::wgpuSharedTextureMemoryBeginAccess(self.raw, texture.raw, descriptor_ptr) };
        result.into()
    }
    ...
    pub fn end_access(&self, texture: Texture, descriptor: &mut SharedTextureMemoryEndAccessState) -> Status {
                let (mut descriptor_ffi, _descriptor_storage) = descriptor.to_ffi();
                let descriptor_ptr = std::ptr::addr_of_mut!(descriptor_ffi);
        let result = unsafe { ffi::wgpuSharedTextureMemoryEndAccess(self.raw, texture.raw, descriptor_ptr) };
...
impl Surface {
    ...
    pub fn get_capabilities(&self, adapter: Adapter, capabilities: &mut SurfaceCapabilities) -> Status {
                let (mut capabilities_ffi, _capabilities_storage) = capabilities.to_ffi();
                let capabilities_ptr = std::ptr::addr_of_mut!(capabilities_ffi);
        let result = unsafe { ffi::wgpuSurfaceGetCapabilities(self.raw, adapter.raw, capabilities_ptr) };
    ...
    pub fn get_current_texture(&self, surface_texture: &mut SurfaceTexture) -> () {
                let (mut surface_texture_ffi, _surface_texture_storage) = surface_texture.to_ffi();
...
impl Texture {
    ...
    pub fn create_view(&self, descriptor: Option<&TextureViewDescriptor>) -> TextureView {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuTextureCreateView(self.raw, std::ptr::null()) };
        unsafe { TextureView::from_raw(result) }
    }

    pub fn create_error_view(&self, descriptor: Option<&TextureViewDescriptor>) -> TextureView {
                let _ = descriptor;
        let result = unsafe { ffi::wgpuTextureCreateErrorView(self.raw, std::ptr::null()) };
        unsafe { TextureView::from_raw(result) }
    }
